...
/*
className={`w-full ${hight} flex flex-col my-4 bg-bg-200 ${rounded} border ${opacity} border-main-border items-center ${p}  ${font ? 'font-normal' : 'font-bold'} transition-all duration-0 ease-linear ${extraStyles()}`}
*/
